...
exports.default = function (target) {
  ...
  target.prototype.customBindListener = function (ele) {
    ...
    dataEvent.split(' ').forEach(function (event) {
      ...
      ele.myListener = checkStatus.bind(_this, dataEventOff);
...
},{"../constant":11}],15:[function(require,module,exports){
'use strict';
  ...
  _createClass(ReactTooltip, [{
    ...
    value: function updatePosition() {
      ...
      var _state3 = this.state,
          ...
          alterLocationIfCantFitIn = _state3.alterLocationIfCantFitIn;
...
},{"./decorators/customEvent":12,"./decorators/isCapture":13,"./decorators/staticMethods":14,"./decorators/windowListener":15,"./style":17,"./utils/aria":18,"./utils/getPosition":19,"./utils/getTipContent":20,"classnames":1,"prop-types":9}],17:[function(require,module,exports){
'use strict';
